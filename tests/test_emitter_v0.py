...
from loki_handler.emitter import LokiEmitterV0

emitter_url = "https://example.net/api/prom/push"
record_kwargs = {
    "name": "test",
...
def create_record(**kwargs):
    ...
    _kwargs = record_kwargs.copy()
    _kwargs.update(kwargs)
    return log.makeRecord(**_kwargs)
...
def test_label_properly_formatted(emitter_v0, label):
    emitter, session = emitter_v0
